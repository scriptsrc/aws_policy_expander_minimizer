...
/// Data then needs to be formatted properly. Save to a file and run this python:
///     import json
///     with open('new_permissions.json') as jsondata:
///         data = json.load(jsondata)
///     with open('new_permissions.json', 'w') as jsondata:
///         json.dump(data, jsondata, indent=2, sort_keys=True)
///     # optionally,remove the extra space at the end of lines. s/\s+$//
